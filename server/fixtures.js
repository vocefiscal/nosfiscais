...
if (PollTapeSubmissions.find().count() === 0) {
  ...
  console.log(JSON.stringify(newPollTapeSubmission, null, 2));
  pollTapeSubmissionId = PollTapeSubmissions.insert(newPollTapeSubmission);
  pollTapeSubmission = PollTapeSubmissions.findOne(pollTapeSubmissionId);
  console.log(JSON.stringify(pollTapeSubmission, null, 2));
}
