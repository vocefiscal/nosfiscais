...
Router.map(function () {
  ...
  this.route('pollTapeSubmissionVerify', {
    ...
    waitOn: function () {
      ...
      return [
        Meteor.subscribe('pollTapeSubmissionsFromIds', [currentPtsId]),
  ...
  this.route('rootLocator', {
    // TODO: path changed to '/br' to "remove" it from the website for now.
    // Have to figure out what to do with this part of the website later.
    path: '/br',
    waitOn: function () {
  ...
  this.route('contato');
  //
  // // Wildcard route has to be left last
